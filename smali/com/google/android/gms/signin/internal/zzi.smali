...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;ZLcom/google/android/gms/common/internal/zzf;Lcom/google/android/gms/internal/zzwl;Lcom/google/android/gms/common/api/GoogleApiClient$ConnectionCallbacks;Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-boolean p3, p0, Lcom/google/android/gms/signin/internal/zzi;->zzbEb:Z

    iput-object p4, p0, Lcom/google/android/gms/signin/internal/zzi;->zzaks:Lcom/google/android/gms/common/internal/zzf;

    iput-object p5, p0, Lcom/google/android/gms/signin/internal/zzi;->zzajF:Lcom/google/android/gms/internal/zzwl;

    invoke-virtual {p4}, Lcom/google/android/gms/common/internal/zzf;->zzoz()Ljava/lang/Integer;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/signin/internal/zzi;->zzaoz:Ljava/lang/Integer;

    iput-object p8, p0, Lcom/google/android/gms/signin/internal/zzi;->zzbEc:Ljava/util/concurrent/ExecutorService;

    return-void
.end method

.method public static zza(Lcom/google/android/gms/internal/zzwl;Ljava/lang/Integer;Ljava/util/concurrent/ExecutorService;)Landroid/os/Bundle;
    .locals 4
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/zzwl;->zzGE()Z
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/zzwl;->isIdTokenRequested()Z
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/zzwl;->getServerClientId()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0}, Lcom/google/android/gms/internal/zzwl;->zzGF()Lcom/google/android/gms/common/api/GoogleApiClient$ServerAuthCodeCallbacks;
    ...
    invoke-direct {v1, p0, p2}, Lcom/google/android/gms/signin/internal/zzi$zza;-><init>(Lcom/google/android/gms/internal/zzwl;Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/zzwl;->zzGG()Z
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/zzwl;->isForceCodeForRefreshToken()Z
...
.method public zzGD()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/google/android/gms/signin/internal/zzi;->zzoJ()Landroid/os/IInterface;

    move-result-object v0

    check-cast v0, Lcom/google/android/gms/signin/internal/zzf;

    iget-object v1, p0, Lcom/google/android/gms/signin/internal/zzi;->zzaoz:Ljava/lang/Integer;

    invoke-virtual {v1}, Ljava/lang/Integer;->intValue()I

    move-result v1

    invoke-interface {v0, v1}, Lcom/google/android/gms/signin/internal/zzf;->zznV(I)V
    :try_end_0
...
.method public zza(Lcom/google/android/gms/common/internal/zzt;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/signin/internal/zzi;->zzaks:Lcom/google/android/gms/common/internal/zzf;

    invoke-virtual {v0}, Lcom/google/android/gms/common/internal/zzf;->zzoq()Landroid/accounts/Account;
    ...
    iget-object v3, p0, Lcom/google/android/gms/signin/internal/zzi;->zzaoz:Ljava/lang/Integer;
...
.method protected synthetic zzaa(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/signin/internal/zzi;->zzgD(Landroid/os/IBinder;)Lcom/google/android/gms/signin/internal/zzf;
...
.method protected zzgD(Landroid/os/IBinder;)Lcom/google/android/gms/signin/internal/zzf;
    .locals 1

    invoke-static {p1}, Lcom/google/android/gms/signin/internal/zzf$zza;->zzgC(Landroid/os/IBinder;)Lcom/google/android/gms/signin/internal/zzf;
...
.method protected zziX()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Lcom/google/android/gms/signin/internal/zzi;->zzajF:Lcom/google/android/gms/internal/zzwl;

    iget-object v1, p0, Lcom/google/android/gms/signin/internal/zzi;->zzaks:Lcom/google/android/gms/common/internal/zzf;

    invoke-virtual {v1}, Lcom/google/android/gms/common/internal/zzf;->zzoz()Ljava/lang/Integer;

    move-result-object v1

    iget-object v2, p0, Lcom/google/android/gms/signin/internal/zzi;->zzbEc:Ljava/util/concurrent/ExecutorService;

    invoke-static {v0, v1, v2}, Lcom/google/android/gms/signin/internal/zzi;->zza(Lcom/google/android/gms/internal/zzwl;Ljava/lang/Integer;Ljava/util/concurrent/ExecutorService;)Landroid/os/Bundle;

    move-result-object v0

    iget-object v1, p0, Lcom/google/android/gms/signin/internal/zzi;->zzaks:Lcom/google/android/gms/common/internal/zzf;

    invoke-virtual {v1}, Lcom/google/android/gms/common/internal/zzf;->zzov()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/gms/signin/internal/zzi;->zzaks:Lcom/google/android/gms/common/internal/zzf;

    invoke-virtual {v2}, Lcom/google/android/gms/common/internal/zzf;->zzov()Ljava/lang/String;
...
.method public zzjl()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/signin/internal/zzi;->zzbEb:Z
