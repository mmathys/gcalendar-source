...
.field public static zzaiY:Z

.field public static zzaiZ:Z

.field private static zzaja:I

.field private static zzajb:Ljava/lang/String;

.field private static zzajc:Ljava/lang/Integer;

.field static final zzajd:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private static final zzaje:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zznd()I

    move-result v0

    sput v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I

    sput-boolean v1, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzaiY:Z

    sput-boolean v1, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzaiZ:Z

    const/4 v0, -0x1

    sput v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzaja:I

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzqd:Ljava/lang/Object;

    sput-object v2, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzajb:Ljava/lang/String;

    sput-object v2, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzajc:Ljava/lang/Integer;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzajd:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzaje:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static honorsDebugCertificates(Landroid/content/pm/PackageManager;)Z
    ...
    invoke-static {}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzne()Z
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    sget-boolean v3, Lcom/google/android/gms/common/internal/zzd;->zzaoa:Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzah(Landroid/content/Context;)V
    ...
    invoke-static {v6}, Lcom/google/android/gms/common/util/zzc;->zzdp(I)Z

    move-result v6

    if-nez v6, :cond_2

    invoke-static {p0}, Lcom/google/android/gms/common/util/zzc;->zzar(Landroid/content/Context;)Z
    ...
    :cond_2
    sget-object v6, Lcom/google/android/gms/common/zzc$zzbz;->zzaiX:[Lcom/google/android/gms/common/zzc$zza;

    invoke-virtual {v5, v4, v6}, Lcom/google/android/gms/common/GoogleSignatureVerifier;->zza(Landroid/content/pm/PackageInfo;[Lcom/google/android/gms/common/zzc$zza;)Lcom/google/android/gms/common/zzc$zza;
    ...
    sget-object v7, Lcom/google/android/gms/common/zzc$zzbz;->zzaiX:[Lcom/google/android/gms/common/zzc$zza;

    invoke-virtual {v5, v6, v7}, Lcom/google/android/gms/common/GoogleSignatureVerifier;->zza(Landroid/content/pm/PackageInfo;[Lcom/google/android/gms/common/zzc$zza;)Lcom/google/android/gms/common/zzc$zza;
    ...
    invoke-virtual {v5, v4, v7}, Lcom/google/android/gms/common/GoogleSignatureVerifier;->zza(Landroid/content/pm/PackageInfo;[Lcom/google/android/gms/common/zzc$zza;)Lcom/google/android/gms/common/zzc$zza;
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/util/zzc;->zzdo(I)I

    move-result v0

    iget v5, v4, Landroid/content/pm/PackageInfo;->versionCode:I

    invoke-static {v5}, Lcom/google/android/gms/common/util/zzc;->zzdo(I)I
...
.method public static isPlayServicesPossiblyUpdating(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzk(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static showErrorNotification(ILandroid/content/Context;)V
    ...
    invoke-static {p1}, Lcom/google/android/gms/common/util/zzc;->zzar(Landroid/content/Context;)Z
    ...
    invoke-static {p1, p0}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->isPlayStorePossiblyUpdating(Landroid/content/Context;I)Z
...
.method public static verifyPackageIsGoogleSigned(Landroid/content/pm/PackageManager;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p0, p1}, Lcom/google/android/gms/common/GoogleSignatureVerifier;->verifyPackageIsGoogleSigned(Landroid/content/pm/PackageManager;Ljava/lang/String;)V
...
.method public static zzY(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, p0, v0, v2}, Lcom/google/android/gms/common/GoogleApiAvailability;->getErrorResolutionIntent(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method private static zza(ILandroid/app/Activity;Landroid/support/v4/app/Fragment;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    :cond_1
    invoke-static {}, Lcom/google/android/gms/common/util/zzn;->zzpO()Z
    ...
    :cond_3
    invoke-static {p1}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzaj(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1, p0}, Lcom/google/android/gms/common/internal/zzg;->zzf(Landroid/content/Context;I)Ljava/lang/String;
...
.method private static zza(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, p1, p0, v7, v4}, Lcom/google/android/gms/common/GoogleApiAvailability;->getErrorResolutionPendingIntent(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/zzn;->zzpP()Z

    move-result v4

    invoke-static {v4}, Lcom/google/android/gms/common/internal/zzx;->zzW(Z)V
    ...
    :goto_0
    invoke-static {p0}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzcB(I)Z
    ...
    sget-object v2, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzajd:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/zzn;->zzpL()Z
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/zzn;->zzpT()Z
...
.method public static zza(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/zzn;->zzpS()Z
...
.method public static zzag(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzajd:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static zzah(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzaje:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_1
    sget-object v1, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzqd:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzajb:Ljava/lang/String;
    ...
    sput-object v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzajb:Ljava/lang/String;
    :try_end_0
    ...
    sput-object v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzajc:Ljava/lang/Integer;
    :try_end_1
    ...
    :goto_0
    :try_start_2
    sget-object v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzajc:Ljava/lang/Integer;
    ...
    sget-object v3, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzajb:Ljava/lang/String;
...
.method public static zzak(Landroid/content/Context;)Z
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/zzn;->zzpR()Z
...
.method public static zzb(Landroid/content/pm/PackageManager;)Z
    ...
    sget-object v2, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzqd:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    sget v3, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzaja:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sget-object v7, Lcom/google/android/gms/common/zzc;->zzaiQ:[Lcom/google/android/gms/common/zzc$zza;
    ...
    invoke-virtual {v4, v3, v5}, Lcom/google/android/gms/common/GoogleSignatureVerifier;->zza(Landroid/content/pm/PackageInfo;[Lcom/google/android/gms/common/zzc$zza;)Lcom/google/android/gms/common/zzc$zza;
    ...
    sput v3, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzaja:I
    :try_end_1
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private static zzcB(I)Z
    .locals 1
...
.method static zzk(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/zzn;->zzpU()Z
    ...
    :cond_1
    invoke-static {p0}, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzak(Landroid/content/Context;)Z
...
.method public static zzne()Z
    ...
    sget-boolean v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzaiY:Z

    if-eqz v0, :cond_0

    sget-boolean v0, Lcom/google/android/gms/common/GooglePlayServicesUtil;->zzaiZ:Z
